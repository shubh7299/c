...
OFFICIAL_CHANNEL = "@INJECTOR_SHUBH"  # Replace with your channel username or ID
CHANNEL_LINK = "https://t.me/INJECTOR_SHUBH"  # Replace with your channel link
...
def bgmi_command(message):
    ...
    try:
        ...
        support_button.add(InlineKeyboardButton("🙏 Support 🙏", url="https://t.me/INJECTOR_SHUBH"))
...
def send_welcome(message):
    ...
    *_A Powerful DDoS Protection Testing Tool_*
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📚 Tutorial", url='https://t.me/INJECTOR_SHUBH')
    )
...
def send_help(message):
    ...
    📌 *Need Help?*
    Contact support: @INJECTOR_SHUBH
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📘 Documentation", url='https://t.me/INJECTOR_SHUBH')
    )
